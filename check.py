...
def f(df0, senko):
    ...
    # 専門科目必修科目
    senmon_hisshu = ['コンピュータリテラシ', 'プログラミング入門A', 'プログラミング入門B', '情報科学概論I', '情報科学概論II', 'データ構造とアルゴリズム','データ構造とアルゴリズム実験', 'システムプログラミング序論', '情報科学基礎実験', '論理回路', '論理回路実験', '{0}実験A'.format(senko), '{0}実験B'.format(senko),'卒業研究A', '卒業研究B']
